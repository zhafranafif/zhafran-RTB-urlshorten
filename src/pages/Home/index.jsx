...
import PinterestLogo from '@static/images/images/icon-pinterest.svg';
import InstagramLogo from '@static/images/images/icon-instagram.svg';
import Hero from '@static/images/images/illustration-working.svg';

import classes from './style.module.scss';
import { setShortURL } from './actions';
    ...
    <div className={classes.wrapper}>
      <section className={classes.hero}>
        <div className={classes.heroHeader}>
          <h1>
            <FormattedMessage id="app_hero_header" />
          </h1>
          <p>
            <FormattedMessage id="app_hero_subheader" />
          </p>
          <button type="button">
            {' '}
        ...
        <img src={Hero} className={classes.heroImage} alt="Hero" />
      </section>
      <section className={classes.mainFeatures}>
          ...
          {data?.map((link, index) => (
            <div className={classes.link} key={index}>
              ...
              <div className={classes.shorten}>
                <h6>{link.shrtlnk}</h6>
                <CopyToClipboard text={link.shrtlnk} onCopy={handleCopy}>
                  <button
                    type="button"
        ...
        <section className={classes.statistic}>
          <h1>
            <FormattedMessage id="app_statistic_header" />
          </h1>
          <p>
            <FormattedMessage id="app_statistic_subheader" />
          </p>
        </section>
        <section className={classes.statisticItem}>
          <div className={classes.statisticItemHeader}>
            ...
            <h3>
              <FormattedMessage id="app_statistic_item1" />
            </h3>
            <p>
              <FormattedMessage id="app_statistic_item1_desc" />
            </p>
          </div>
          ...
          <div className={`${classes.statisticItemHeader} header1`}>
            ...
            <h3>
              <FormattedMessage id="app_statistic_item2" />
            </h3>
            <p>
              <FormattedMessage id="app_statistic_item2_desc" />
            </p>
          </div>
          <div className={classes.line} />
          <div className={classes.statisticItemHeader}>
            ...
            <h3>
              <FormattedMessage id="app_statistic_item3" />
            </h3>
            <p>
              <FormattedMessage id="app_statistic_item3_desc" />
            </p>
          </div>
        </section>
      </section>
      <section className={classes.boost}>
        <h1>
          <FormattedMessage id="app_boost_header" />
        </h1>
        <button type="button">
          {' '}
          <FormattedMessage id="app_boost_button" />
        </button>
      </section>
      <section className={classes.footer}>
        ...
        <div className={classes.footerLink}>
          <div className={classes.features}>
            ...
            <ul>
              <li>
                <a>
                  <FormattedMessage id="app_footer_features1" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_features2" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_features3" />
                </a>
              </li>
            </ul>
          </div>
          <div className={classes.resources}>
            ...
            <ul>
              <li>
                <a>
                  <FormattedMessage id="app_footer_resources1" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_resources2" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_resources3" />
                </a>
              </li>
            </ul>
          </div>
          <div className={classes.company}>
            ...
            <ul>
              <li>
                <a>
                  <FormattedMessage id="app_footer_company1" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_company2" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_company3" />
                </a>
                <a>
                  <FormattedMessage id="app_footer_company4" />
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className={classes.socmed}>
          <img src={FBLogo} alt="Facebook" style={{ width: '30px', height: '30px' }} />
          <img src={TwitterLogo} alt="Twitter" style={{ width: '30px', height: '30px' }} />
          <img src={PinterestLogo} alt="Pinterest" style={{ width: '30px', height: '30px' }} />
